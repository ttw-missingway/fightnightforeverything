...
function LegacyLadder({ save, earned }) {
  ...
  return (
    <div>
      ...
      <div className="card">
        <div className="row spread">
          <span><span className="gold" style={{ fontSize: 22, fontWeight: 700 }}>{points}</span> <span className="dim">prestige — a score this lineage has run up, not a currency</span></span>
